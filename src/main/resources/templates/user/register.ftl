...
$().ready(function() {
	...
	$captchaImage.click(function() {
		$captchaImage.hide().attr("src", "${ctx}/kaptcha/getKaptchaImage?timestamp=" + new Date().getTime()).fadeIn();
	});
									...
									<tr>
										...
										<td>
											<span class="fieldSet">
												...
												<img id="captchaImage" style="width:80px;height:30px" class="captchaImage" src="${ctx}/kaptcha/getKaptchaImage" title="点击更换验证码" />
											</span>
										</td>
									</tr>
								<tr>
